...
from .geometry import ScreenRect, choose_screen, panel_position, top_right_position
...
class TabBar(QWidget):
    ...
    def _current_screen_rect(self, point: QPoint | None = None) -> ScreenRect | None:
        screens = [ScreenRect.from_rect(screen.availableGeometry()) for screen in QApplication.screens()]
        if not screens:
            return None
