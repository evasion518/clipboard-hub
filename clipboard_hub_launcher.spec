...
"""
Clipboard Hub — PyInstaller spec

构建:
    pyinstaller clipboard_hub_launcher.spec

输出:
    dist/Clipboard Hub/Clipboard Hub.exe
"""

a = Analysis(
    ["clipboard_hub_launcher.py"],
    pathex=[],
    binaries=[],
    datas=[],
    hiddenimports=[
